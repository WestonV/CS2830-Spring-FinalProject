...
<body>
    ...
    <div class="carousel black">
        ...
        <a onclick="updateTrailer('ready-player-one')" id="ready-player-one" class="carousel-item hoverable"><img src="https://image.tmdb.org/t/p/w500/pU1ULUq8D3iRxl1fdX2lZIzdHuI.jpg"></a>
